...
import "./App.css";
import { FaBars, FaChevronLeft, FaSearchLocation } from "react-icons/fa";
      ...
      <div className="App" style={{ zIndex: 0, marginLeft: { newSize } }}>
        <nav id="mySidenav">
          ...
          <div
            id="logo"
          >
            <strong style={{color:'#5e3023'}}>VolunteerToday</strong>
          </div>
          <div>
            <FaSearchLocation id="search" style={{ height: "50px", color: "black", paddingRight: 10}} />
          </div>
          <div
            id="openmenu"
