...
import "./App.css";
import { FaBars, FaChevronLeft, FaSearchLocation, FaShoppingCart} from "react-icons/fa";
      ...
      <div className="App" style={{ zIndex: 0, marginLeft: { newSize } }}>
        <nav id="mySidenav">
          ...
          {/* <span style={{ padding: "3px" }}>
                <FaBars style={{ height: "50px", color: "black" }} />
              </span>
            </span> */}
          {/* </button> */}
          
          <div id="logo">
            <strong style={{ color: "#5e3023", marginLeft: "10px" }}>
            <Link
            to="/"
          ...
          <FaShoppingCart to='/shop' style={{ height: "20px", width:'20px' }}/>
          </div>
          
          {/* <div>
            <FaSearchLocation
              id="search"
              style={{ height: "50px", color: "black", paddingRight: 10 }}
            />
          </div> */}
          <div
            id="openmenu"
